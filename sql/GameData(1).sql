...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.0.4deb2%2Bdeb11u1&nocache=6556258358ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.0.4deb2%2Bdeb11u1" media="print" id="printcss">
    <title>kaelari.tech / localhost | phpMyAdmin 5.0.4deb2+deb11u1</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/whitelist.php?v=5.0.4deb2%2Bdeb11u1"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&amp;v=5.0.4deb2%2Bdeb11u1"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/export_output.js?v=5.0.4deb2%2Bdeb11u1"></script>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"db_structure.php",lang:"en",server:"1",table:"",db:"",token:"35602730573f243b2572612267526c2b",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:true,rootPath:"/kaelarimyadmin/",arg_separator:"&",PMA_VERSION:"5.0.4deb2+deb11u1",auth_type:"cookie",user:"root"});
...
<body>
      ...
      <div id="pma_navigation_header">
        ...
        <div id="navipanellinks">
          <a href="index.php" title="Home"><img src="themes/dot.gif" title="Home" alt="Home" class="icon ic_b_home"></a>
                      ...
                      <a class="logout disableAjax" href="logout.php" title="Log out"><img src="themes/dot.gif" title="Log out" alt="Log out" class="icon ic_s_loggoff"></a>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="tbl_recent_favorite.php?db=KF_game&amp;table=GameData">`KF_game`.`GameData`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=KF_Platform&amp;table=queue">`KF_Platform`.`queue`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=KF_Platform&amp;table=Games">`KF_Platform`.`Games`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=eternalladder&amp;table=templates">`eternalladder`.`templates`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=eternalladder&amp;table=spoilers">`eternalladder`.`spoilers`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=Bubba&amp;table=templates">`Bubba`.`templates`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=Bubba&amp;table=wishboard">`Bubba`.`wishboard`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=Bubba&amp;table=lots">`Bubba`.`lots`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=auction&amp;table=templates">`auction`.`templates`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=auction&amp;table=lots">`auction`.`lots`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class='block '><a href='server_databases.php?server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='server_databases.php?server=1' title='New'>New</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.YXVjdGlvbg==</span><span class='hide vPath'>cm9vdA==.YXVjdGlvbg==</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=auction&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=auction' title='Structure'>auction</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.QnViYmE=</span><span class='hide vPath'>cm9vdA==.QnViYmE=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=Bubba&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=Bubba' title='Structure'>Bubba</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.ZXRlcm5hbGxhZGRlcg==</span><span class='hide vPath'>cm9vdA==.ZXRlcm5hbGxhZGRlcg==</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=eternalladder&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=eternalladder' title='Structure'>eternalladder</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h</span><span class='hide vPath'>cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=information_schema' title='Structure'>information_schema</a><div class="clearfloat"></div></li><li class="navGroup"><div class='block'><i></i><b></b><a class="expander loaded container" href='#'><span class='hide aPath'>cm9vdA==</span><span class='hide vPath'>cm9vdA==.S0Y=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><i><div class='block '><u><img src="themes/dot.gif" title="Groups" alt="Groups" class="icon ic_b_group"></u></div>&nbsp;KF</i><div class="clearfloat"></div><div style='display: none;' class='list_container'><ul><li class="database database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.S0ZfY2FyZHM=</span><span class='hide vPath'>cm9vdA==.S0Y=.Y2FyZHM=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=KF_cards&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=KF_cards' title='Structure'>KF_cards</a><div class="clearfloat"></div></li><li class="database database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.S0ZfZ2FtZQ==</span><span class='hide vPath'>cm9vdA==.S0Y=.Z2FtZQ==</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=KF_game&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=KF_game' title='Structure'>KF_game</a><div class="clearfloat"></div></li><li class="database last database"><div class='block'><i></i><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.S0ZfUGxhdGZvcm0=</span><span class='hide vPath'>cm9vdA==.S0Y=.UGxhdGZvcm0=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=KF_Platform&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=KF_Platform' title='Structure'>KF_Platform</a><div class="clearfloat"></div></li></ul></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.bXlzcWw=</span><span class='hide vPath'>cm9vdA==.bXlzcWw=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=mysql' title='Structure'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h</span><span class='hide vPath'>cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=performance_schema' title='Structure'>performance_schema</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cGhwbXlhZG1pbg==</span><span class='hide vPath'>cm9vdA==.cGhwbXlhZG1pbg==</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=phpmyadmin' title='Structure'>phpmyadmin</a><div class="clearfloat"></div></li>
  </ul>
</div>
...
<input type="hidden" name="token" value="35602730573f243b2572612267526c2b">
